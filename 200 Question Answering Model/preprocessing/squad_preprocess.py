...
# 아래의 코드는 https://github.com/priya-dwivedi/cs224n-Squad-Project/tree/master/code/preprocessing 에서 가져와서
# Anderson 이 python3.6에 돌아갈수 있도록 약간의 수정만 하였습니다.
...
def preprocess_and_write(dataset, tier, out_dir):
    ...
    print("Number of (context, question, answer) triples discarded due "
          "to char -> token mapping problems: ", num_mappingprob)
    print("Number of (context, question, answer) triples discarded because"
          " character-based answer span is unaligned with tokenization: ", num_tokenprob)
    print("Number of (context, question, answer) triples discarded due "
          "character span alignment problems (usually Unicode problems): ", num_spanalignprob)
    print("Processed %i examples of total %i\n" % (num_exs,
                                                   num_exs + num_mappingprob + num_tokenprob + num_spanalignprob))
